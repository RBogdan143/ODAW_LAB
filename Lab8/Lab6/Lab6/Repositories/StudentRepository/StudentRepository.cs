...
namespace Lab6.Repositories.StudentRepository
{
    ...
    {
        public StudentRepository(Lab6Context Lab5Context) : base(Lab5Context) { }
        ...
        {
            var result = _lab5Context.Models1.Join(_lab5Context.Models2, model1 => model1.Id, model2 => model2.Model1Id,
