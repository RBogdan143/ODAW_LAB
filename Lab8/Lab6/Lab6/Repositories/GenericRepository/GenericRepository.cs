...
namespace Lab6.Repositories.GenericRepository
{
    public class GenericRepository<TEntity>: IGenericRepository<TEntity> where TEntity : BaseEntity
    {
        protected readonly Lab6Context _lab5Context;
        protected readonly DbSet<TEntity> _table;

        public GenericRepository(Lab6Context lab4Context)
        {
            _lab5Context = lab4Context;
            _table = _lab5Context.Set<TEntity>();
        }
        ...
        public bool Save()
        {
            return _lab5Context.SaveChanges() > 0;
        }
        public async Task<bool> SaveAsync()
        {
            return await _lab5Context.SaveChangesAsync() > 0;
        }
